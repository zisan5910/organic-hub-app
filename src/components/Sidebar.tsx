...
const Sidebar = () => {
  ...
  const externalLinks = [
    { href: 'https://admission-calendar.com', icon: GraduationCap, label: 'Admission Calendar' },
    { href: 'https://addresacademy.com/table-qna/?university=DU&year=2025', icon: FileText, label: 'Question Analysis' },
  ];
  ...
  return (
    <aside className="hidden lg:flex flex-col w-52 fixed left-0 top-14 bottom-0 bg-sidebar border-r border-sidebar-border">
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="p-3 space-y-1">
          <p className="text-xs text-muted-foreground px-4 mb-2 font-medium">রিসোর্স</p>
